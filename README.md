...
- notebooks: All the notebooks we need for the competition\n
     |___ data_ingestion: notebooks or scripts needed to perform data ingestion
     |___ data_transformation: notebooks or scripts needed to transform data transformation and EDA
